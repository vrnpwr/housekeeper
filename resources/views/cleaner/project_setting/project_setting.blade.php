							...
							<div class="row">
								...
								<div class="col-3">
									<label class="switch">
										...
										<input name="project_setting[{{$key}}][{{$keyName}}]" type="checkbox" checked="" value="1"
											class="default">
										@else
						...
						<div class="card-header">
							<div class="row">
								...
								<div class="col-3">
									<label class="switch">
										<input type="hidden" name="project_setting[{{$key}}][title]" value="{{$value['title']}}">
										<input type="hidden" name="project_setting[{{$key}}][description]"
											value="{{$value['description']}}">
										<input type="hidden" name="project_setting[{{$key}}][key]" value="{{$value['key']}}">
										<input name="project_setting[{{$key}}][{{$value['key']}}]" type="checkbox" value="1"
											class="default">
										<span class="slider round"></span>
									</label>
								</div>
