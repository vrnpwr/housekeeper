...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark"><h3><i class="fas fa-home mr-3"></i>Profile Setting</h3> </h1>
			</div>
			<div class="col-sm-6">
						...
						<div class="row">							
							<div class="col-8">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control last-name" value="{{ $user->last_name }}" 
								...
								<div class="row">
									<div class="col-3">										
										<div class="form-group">
											...
											<input id="password" type="password" class="form-control" value="{{ $user->password }}" name="current_password" autocomplete="current-password">
										</div>
									</div>
