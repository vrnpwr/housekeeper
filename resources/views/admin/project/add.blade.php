							...
							<div class="row">
								...
								<div class="row">
									...
									<div class="col-6">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control float-right dates_timmings" id="reservationtime">
											</div>
											<!-- /.input group -->
										</div>
										<!-- /.form group -->
									...
									<div class="col-3">
										<div class="form-group">
											...
											<input type="text" name="cleaning_price" value="" class="form-control" id="cleaning_price" placeholder="Cleaning Price">
										</div>
									</div>
									...
									<div class="col-3">
										<div class="form-group mt-4 ml-3" id="property_default_checklist_box">
											<input type="checkbox" name="property_default_checklist" class="" id="property_default_checklist" value="1">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="radio" class="rate" name="rate" value="flat_rate" > A flat rate <br>
											<input type="radio" class="rate" name="rate" value="hourly_rate" > Hourly rate <br>
											<input type="radio" class="rate" name="rate" value="property_rate"  checked > The property rate for the cleaner <br>
										</div>
									</div>
								</div>
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<select class="form-control" id="checklist_id" name="checklist_id">
												<option selected="" disabled="">-Select Checklist-</option>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea name="additional_notes" id="additional_notes" class="form-control" placeholder="Additional Notes visible to cleaner(optional)"></textarea>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea name="host_notes" id="host_notes" class="form-control" placeholder="Additional Notes visible to cleaner(optional)"></textarea>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<!-- Publish Project -->
											<input type="checkbox" id="publish_project" name="publish_project" value="0" >&nbsp;&nbsp;
								...
								<div class="row">
									<div class="col-12">
										<button class="btn btn-success float-right" id="project-btn">Submit</button>
									</div>
									<!-- Error Messages -->
...
<script>
    ...
    $('#project-btn').click(function(event) {
      ...
      insertChecklist(user_id, property_id, dates_timmings, rate, cleaning_price, additional_notes, host_notes, checklist_id, publish_project, restrict_cleaner);
  });
    /* Insert Property Data*/
    function insertChecklist(user_id,property_id, dates_timmings, rate, cleaning_price, additional_notes, host_notes, checklist_id, publish_project, restrict_cleaner){

    	$.ajax({
    		type: 'POST',
    		url: '{{ action('ProjectController@store') }}',
    		headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
    		data:{user_id, property_id, dates_timmings, rate, cleaning_price, additional_notes, host_notes, checklist_id, publish_project, restrict_cleaner},
